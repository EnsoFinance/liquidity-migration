...
// TODO: update enso interfaces to solidity >8
// import { StrategyController, GenericRouter } from "@bodhi/contracts/contracts/StrategyController.sol";
...
contract LiquidityMigration {
    ...
    enum AcceptedProtocols{ PieDao, dHedge } // Accepted protocols
    mapping(AcceptedProtocols => address) public protocols; // Protocol => Factory address
    ...
    constructor(AcceptedProtocols[] memory protos, address[] memory factories, address _genericRouter) {
    ...
    function inRegistry(address poolToken, AcceptedProtocols protocol) public view returns (bool) {
        if (protocol == AcceptedProtocols.PieDao) {
