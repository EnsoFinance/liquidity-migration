...
describe("MigrationCoordinator tests: ", function () {
  ...
  it("Should deploy new liquidity migration contract", async function () {
    ...
    liquidityMigrationV2 = await LiquidityMigrationV2.connect(signers.admin).attach(deployments.mainnet.LiquidityMigrationV2)
  })
  ...
  it("Should setup migration coordinator", async function () {
    ...
    migrationCoordinator = await MigrationCoordinator.connect(signers.admin).attach(deployments.mainnet.MigrationCoordinator)
  })
