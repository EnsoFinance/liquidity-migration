...
describe("Indexed: Unit tests", () => {
    ...
    it('trial', async () => {
        console.log(dpiPool.address)
    });

    const dpi_setup = async () => {
        ...
        dpiStrategy = await deploy_strategy(
            "DPI",
            "DPI",
    ...
    const indexed_setup = async () => {
        ...
        indexedStrategy = await deploy_strategy(
            "indexed",
            "inde",
